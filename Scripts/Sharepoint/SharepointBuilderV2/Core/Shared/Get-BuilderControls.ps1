...
function Get-BuilderControls {
    ...
    $Ctrl = @{
        ...
        # USE ROBUST FIND
        EdPropPanel                   = & $Find "EdPropPanel"
        EdPanelFile                   = & $Find "EdPanelFile"
        EdPropPanelPerm               = & $Find "EdPropPanelPerm"
        EdPropPanelTag                = & $Find "EdPropPanelTag"
        EdPropPanelLink               = & $Find "EdPropPanelLink"
        EdPropPanelInternalLink       = & $Find "EdPropPanelInternalLink"
        EdPropPanelPub                = & $Find "EdPropPanelPub"
        ...
        # Folder Inputs
        EdNameBox                     = & $Find ("EdNameBox")
        EditorDisplayNameBox          = & $Find ("EditorDisplayNameBox")
        EditorDescriptionBox          = & $Find ("EditorDescriptionBox")
        EdFolderIdBox                 = & $Find ("EdFolderIdBox")
        EdFolderRelativePathBox       = & $Find ("EdFolderRelativePathBox")
        EdFolderDeleteButton          = & $Find ("EdFolderDeleteButton")
        ...
        EdDynamicTagInfoButton        = & $Find ("EdDynamicTagInfoButton")
        ...
        FormDisplayNameBox            = & $Find ("FormDisplayNameBox")
        FormDescriptionBox            = & $Find ("FormDescriptionBox")
